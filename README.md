...
- On your website source code where [GTM is loaded](https://developers.google.com/tag-platform/tag-manager/server-side/dependency-serving?tag=gtm), you should replace:
